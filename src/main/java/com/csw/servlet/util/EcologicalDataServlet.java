...
@WebServlet(name = "VectorDataServlet")
public class EcologicalDataServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String,String>> results = GetSpecificData.getData("ecologicalData",pageCount,pageNum);
