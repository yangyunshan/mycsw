...
public class GeologicalHazardDataServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String,String>> results = GetSpecificData.getData("geologicalHazardData",pageCount,pageNum);
